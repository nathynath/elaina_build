...
# Main
KERNEL_ROOTDIR=/workspace/Gitpod-Workspaces/elaina # IMPORTANT ! Fill with your kernel source root directory.
DEVICE_DEFCONFIG=vendor/elaina-perf_defconfig # IMPORTANT ! Declare your kernel source defconfig file here.
